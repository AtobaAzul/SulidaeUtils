package net.atobaazul.sulidae_utils.common.device;

import com.george_vi.electroenergetics.simulation.BridgeCollector;
import com.george_vi.electroenergetics.simulation.SimulatedDevice;
import com.george_vi.electroenergetics.simulation.SimulationResults;
import net.atobaazul.sulidae_utils.common.block.ElectrodeBlock;
...
public class ElectrodeDevice extends SimulatedDevice {
    public ElectrodeDevice(ResourceLocation id) {
        super(id);
    }
    ...
    public void postTick(BlockPos pos, Level level, SimulationResults results, CompoundTag extraData) {
        ...
        if (extraData.getBoolean("Source")) {
            ...
            if (storedEnergy < MAX_ENERGY && level.isLoaded(pos)) {
                ...
                IEnergyStorage energyStorage = level.getCapability(Capabilities.EnergyStorage.BLOCK, pos.relative(state.getValue(ElectrodeBlock.FACING).getOpposite()), state.getValue(ElectrodeBlock.FACING));
